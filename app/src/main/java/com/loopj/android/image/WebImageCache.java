...
public class WebImageCache {
	...
	public void put(String url, Bitmap bitmap) {
		...
		/*try {
			Log.d("Tlatoque.WebImageCache", "Mem " + memoryCache.size() + "");
			Log.d("Tlatoque.WebImageCache", "Dsk " + new File(diskCachePath).list().length + "");
		}
		catch (Exception e) {
			Log.d("Tlatoque.WebImageCache", "?? Shouldn't happen: " + e.getLocalizedMessage());
		}*/
	}
	...
	public void remove(String url) {
		...
		Log.d("Tlatoque.WebImageCache", "removing");
...
//		Log.d("Tlatoque.WebImageCache", memoryCache.size() + "");
//		Log.d("Tlatoque.WebImageCache", "removing from memory only.");
		memoryCache.remove(getCacheKey(url));
//		Log.d("Tlatoque.WebImageCache", memoryCache.size() + "");
	}
